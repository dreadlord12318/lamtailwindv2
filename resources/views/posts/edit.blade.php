                    ...
                    <div class="mt-6 pt-10 grid gap-16 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-12">
                        <div class="col-span-2">
                            ...
                            <label for="base-input"
                                ...
                                <input type="text" name="title" id="base-input" value="{{ old('title', $post->title) }}"
                                ...
                                @endif
                                    ...
                                    <label for="base-input"
                                    class="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-gray-300">Posts Caption</label>
                                <input type="text" name="caption" id="base-input"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <label for="base-input"
                                    class="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-gray-300">Meta Title</label>
                                <input type="text" name="metatitle"  value="{{ old('metatitle', $post->metatitle) }}" id="base-input"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div class="flex items-center bg-blue-500 text-white text-sm font-bold my-2 rounded-md px-4 py-3"
                                    ...
                                    <p>{{ $errors->first('metatitle') }}</p>
                                </div>
                                @endif

                                <label for="base-input"
                                    class="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-gray-300">Meta Description</label>
                                <input type="text" name="metadesc" value="{{ old('metadesc', $post->metadesc) }}" id="base-input"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
