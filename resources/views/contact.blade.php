...
@endif
  ...
  <p>{{ $errors->first('last_name') }}</p>
        ...
        <div class="sm:col-span-2">
          <div class="mt-1">
          <input id="email" placeholder="Email" name="email" type="email" autocomplete="email" value = "{{old('email')}}"  class="block w-full font-concourset3 text-lg font-normal-400 tracking-normal leading-none  py-3.5 px-4 shadow-sm  focus:ring-grape-500 focus:border-grape-500 border-gray-300 rounded-md">
          @if($errors->has('email'))
