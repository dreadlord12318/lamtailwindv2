...
<div class="relative top-16 pb-20 bg-blue-700">
  <div class="absolute inset-0">
    <img class="w-full h-full object-cover" src="images/LAMB-Site-Image-Header_Services.jpg" alt="Lambent’s values inform our work.">
    <div class="absolute inset-0 h-full bg-blue-700 mix-blend-multiply" aria-hidden="true"></div>
  </div>
  <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
    <h1 class="text-6xl text-left  font-concourset6  leading-tight font-normal tracking-normal text-newcolor-700 capitalize">Lambent Outsourcing Services</h1>
    <p class="mt-6 font-copy text-2xl font-normal tracking-normal leading-normal text-left text-newcolor-700 max-w-3xl">Whether you're looking for long-term employees or need some extra help on a project basis, we've got you covered. </p>
  </div>
</div>
...
<div class="relative mt-8 bg-white">
  <div class="lg:absolute lg:inset-0">
    <div class="lg:absolute lg:inset-y-0 lg:left-0 lg:w-1/2">
      <img class="h-56 w-full object-cover lg:absolute lg:h-full" src="images/LAMB-Site-Image-Services.jpg" alt="">
    </div>
  </div>
