...
<footer class="bg-lambright-500">
  <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
    <nav class="-mx-5 -my-2 flex flex-wrap justify-start" aria-label="Footer">
      ...
      <div class="px-5 py-2">
        <a href="/termsandcondition" class="text-base leading-normal leading-snug font-semibold text-center tracking-wide font-concourset6 text-white hover:text-white">
          TERMS OF SERVICE
        </a>
      </div>
