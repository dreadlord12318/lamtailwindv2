...
<div class="relative py-16 bg-white overflow-hidden">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="text-lg max-w-prose mx-auto">
            <h1>
                ...
                <span
                    class="mt-2 block font-concourset6 text-5xl font-normal tracking-normal leading-tight text-center text-slate-900 capitalize">Web
                    Site Terms</span>
            </h1>
        </div>
        <div
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="text-lg max-w-prose mx-auto">
            <h1>
                <span
                    class="mt-2 block font-concourset6 text-4xl font-normal tracking-normal leading-tight text-center text-slate-900 capitalize ">Compensation</span>
            </h1>
        </div>
        <div
            class="mt-6 prose prose-indigo prose-lg font-copy font-normal text-xl tracking-normal leading-relaxed text-lambright-50 normal-case mx-auto">
        ...
        <div class="text-lg max-w-prose mx-auto">
            <h1>
                <span
                    class="mt-2 block font-concourset6 text-4xl font-normal tracking-normal leading-tight text-center text-slate-900 capitalize ">Termination</span>
            </h1>
        </div>
        <div
            class="mt-6 prose prose-indigo prose-lg font-copy font-normal text-xl tracking-normal leading-relaxed text-lambright-50 normal-case mx-auto">
        ...
        <div class="text-lg max-w-prose mx-auto">
            <h1>
                <span
                    class="mt-2 block font-concourset6 text-4xl font-normal tracking-normal leading-tight text-center text-slate-900 capitalize ">General
                    Terms</span>
            </h1>
        </div>
        <div
