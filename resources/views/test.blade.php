        ...
        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
          ...
          {{ csrf_field()}}
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-1">
                <input type="text"  name="subject" id="subject" value="{{$request->last_name}} / {{$request->first_name}}" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" readonly>
              </div>
            </div>
            <div class="sm:col-span-2">
              <div class="flex justify-between">
