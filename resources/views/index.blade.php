...
<div class="relative bg-lambright-600 overflow-hidden">
  ...
  <div class="relative pt-6 pb-16 sm:pb-24">
    ...
    <div class="pt-10 bg-lambright-600 sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden">
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div class="mt-12 bg-blend-overlay -mb-16 sm:-mb-48 lg:m-0 lg:relative">
            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
              ...
              <img class="w-full lg:absolute lg:inset-y-0 lg:left lg:h-full lg:w-full " src="images/LAMB-Site-Image-Home_Header.jpg" alt="">
              <div class="absolute inset-0 bg-lambright-600 mix-blend-multiply" aria-hidden="true"></div>
            </div>
          </div>
        </div>
      </div>
