                ...
                <div class="pt-10 bg-blue-700 sm:pt-14 lg:pt-0 lg:pb-20 lg:overflow-hidden">
                    <div class="mx-auto max-w-7xl lg:px-8">
                        <div class="lg:grid lg:grid-cols-3 gap-8 ">
                                ...
                                <div class="lg:py-24">
                                    ...
                                    <div class="mt-10 sm:mt-12">
                                        ...
                                        <div role="alert" class="w-full">
                                            <div
                                                class="bg-lambright-600 mt-2 text-white font-bold top-10 rounded-t px-4 py-3">
                                                Success
                                            </div>
                                            <div
                                        ...
                                        <div class="mt-5">
                                            <form action="/contact" method="POST"
                                                class="sm:max-w-2xl sm:mx-auto lg:mx-0">
                                                {{ csrf_field()}}
                                                <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                                    <div>
                                                        <div class="mt-1">
                                                            <input type="text" placeholder="First Name"
                                                                ...
                                                                class="block w-full py-3.5 px-4 font-concourset3 text-base font-normal text-newcolor-200 tracking-normal leading-relaxed normal-case shadow-sm s focus:ring-grape-500 focus:border-grape-500 border-gray-300 rounded-md">
                                                        </div>
                                                    ...
                                                    <div class="sm:col-span-2 bg-lime-500 rounded-md shadow ">
                                                        <div class="mt-1">
                                                            <button type="submit"
                                                                class="block w-full py-3  font-concourset6 text-base normal-case  font-normal tracking-normal leading-relaxed align-middle px-5 rounded-md shadow  text-white hover:bg-lime-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 focus:ring-offset-gray-900">Let's
                                                                Talk</button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class=" bg-blend-overlay -mb-16 -top-40 sm:-mb-48 lg:m-0 sm:static w-full lg:relative">
                                <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
                                    <!-- Illustration taken from Lucid Illustrations: https://lucid.pixsellz.io/ -->
                                    <img class="w-60 mb-28 ml-14 mt-32 top-48 sm:mb-28 sm:ml-40 lg:ml-0  lg:w-full  md:left-16 sm:left-0 lg:absolute lg:left "
