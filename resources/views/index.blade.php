  ...
  <p>{{ $errors->first('last_name') }}</p>
          ...
          <div class=" bg-blend-overlay -mb-16 -top-40 sm:-mb-48 lg:m-0 sm:static w-full lg:relative">
            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
              ...
              <img class="w-60 mb-28 ml-14 mt-32 top-48 sm:mb-28 sm:ml-40 lg:ml-0  lg:w-full  md:left-16 sm:left-0 lg:absolute lg:left "  src="images/LAMB-Si_te-Image-Home-Header.svg" alt="Supercharge your productivity with offshore virtual assistants.">
    ...
    What’s better than magic? Free magic!  
      ...
      <div class="mt-8">
        ...
        <!-- <form  action="/transaction" class="sm:max-w-xl sm:mx-auto lg:mx-0" method="POST">
             ...
             <a href = "/freemagic"  class="inline-flex items-center bg-lamblue-600 justify-center text-white px-5 py-3 border border-transparent rounded-md font-concourset6 text-base normal-case font-normal tracking-normal leading-relaxed hover:bg-lamblue-400">Schedule a Call Today</a>
        </div>
      </div>
    </div>
  </div>
