...
<div class="relative bg-lambright-500 overflow-hidden">
  ...
  <div class="relative pt-6">
    ...
    <div class="pt-10 bg-lambright-500 sm:pt-14 lg:pt-8 lg:pb-20 lg:overflow-hidden">
      ...
      {{ csrf_field()}}
      <div>
        <label for="first-name" class="block font-copy text-xl font-normal tracking-normal leading-relaxed text-white">First name</label>
        <div class="mt-1">
...
<p>{{ $errors->first('first_name') }}</p>
      ...
      <div>
        <label for="last-name" class="block font-copy text-xl font-normal tracking-normal leading-relaxed text-white">Last name</label>
        <div class="mt-1">
...
<p>{{ $errors->first('last_name') }}</p>
      ...
      <div class="sm:col-span-2">
        <label for="email" class="block font-copy text-xl font-normal tracking-normal leading-relaxed text-white">Email</label>
        <div class="mt-1">
...
<p>{{ $errors->first('terms') }}</p>
  ...
  <div class="relative">
    ...
    <!-- line -->
    <div class="block bg-lamblue-500 w-11 h-6 border-2 border-transparent rounded-full cursor-pointer"></div>
    <!-- dot -->
    <div class="dot absolute left-0.5 top-0.5 bg-white w-5 h-5 rounded-full transition"></div>
          ...
          <div class="ml-3">
            <p class="text-base text-white">
              ...
              <a target= "_blank" href="/privacy" class="font-medium text-white underline">Privacy Policy</a>
              and
              <a target= "_blank" href="/GDPR" class="font-medium text-white underline">Cookie Policy</a>.
            </p>
          </div>
        </div>
      </div>
      <div class="sm:col-span-2">
        <button type="submit" class="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-newgrowth-300 hover:bg-newgrowth-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          Let's talk
        </button>
      </div>
    </form>
          ...
          <div class=" bg-blend-overlay -mb-16 -top-40 sm:-mb-48 lg:m-0 lg:relative">
            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
              ...
              <img class="lg:ml-24  w-11/12 lg:absolute lg:top-40 lg:left " src="images/LAMB-Site-Image-Home_HeaderIso.svg" alt="">
