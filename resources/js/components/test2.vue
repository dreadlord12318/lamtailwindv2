          ...
          <div class="py-6 px-3">
            ...
            <p class="mt-8">
             ...
             <form  action="/transaction" class="sm:max-w-xl sm:mx-auto lg:mx-0" method="POST">
              ...
              <button type="submit" class="mt-8 block w-full bg-newcolor-300 border border-newcolor-300 rounded-md py-2 font-concourset6 text-lg capitalize font-normal tracking-normal leading-normal text-center text-white hover:bg-lambright-600">Let's talk</button>
             </form>
          </div>
